...
public final class NavigateToChatControllerParams {
    ...
    // MARK: - iMe
    public let showsUnreadCountOnBackButton: Bool
    
    
    public init(navigationController: NavigationController, chatController: ChatController? = nil, context: AccountContext, chatLocation: ChatLocation, subject: ChatControllerSubject? = nil, botStart: ChatControllerInitialBotStart? = nil, updateTextInputState: ChatTextInputState? = nil, activateInput: Bool = false, keepStack: NavigateToChatKeepStack = .default, purposefulAction: (() -> Void)? = nil, scrollToEndIfExists: Bool = false, animated: Bool = true, options: NavigationAnimationOptions = [], parentGroupId: PeerGroupId? = nil, completion: @escaping () -> Void = {}, showsUnreadCountOnBackButton: Bool = true) {
        self.showsUnreadCountOnBackButton = showsUnreadCountOnBackButton
        // MARK: -
...
public protocol SharedAccountContext: class {
    ...
    // MARK: - iMe
    func makeChatControllerTitlePanelNodeContainerInterface() -> ChatControllerTitlePanelNodeContainerInterface
    // MARK: -
}
