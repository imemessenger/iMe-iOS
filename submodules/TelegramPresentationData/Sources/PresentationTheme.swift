...
public final class PresentationThemeChatInputPanel {
    ...
    // MARK: -
        ...
        // MARK: - iMe
        self.panelIconColor = mediaRecordingDotColor
        // MARK: -
    }
}
...
public final class PresentationTheme: Equatable {
    ...
    // MARK: - iMe
    public let iMe: PresentationTheme_iMe
    // -
    ...
    public init(name: PresentationThemeName, referenceTheme: PresentationBuiltinThemeReference, overallDarkAppearance: Bool, baseColor: PresentationThemeBaseColor?, intro: PresentationThemeIntro, passcode: PresentationThemePasscode, rootController: PresentationThemeRootController, list: PresentationThemeList, chatList: PresentationThemeChatList, chat: PresentationThemeChat, actionSheet: PresentationThemeActionSheet, contextMenu: PresentationThemeContextMenu, inAppNotification: PresentationThemeInAppNotification, preview: Bool = false) {
        ...
        self.iMe = PresentationTheme_iMe(
            accentColour: list.itemAccentColor,
            backgroundColour: chatList.backgroundColor,
            secondaryBackgroundColour: chatList.sectionHeaderFillColor,
            titleTextColour: chatList.titleColor,
            secondaryTextColour: list.itemSecondaryTextColor,
            disableButtonColour: list.itemDisabledTextColor,
            newTagBackgroundColour: .init(red: 255 / 255, green: 129 / 255, blue: 129 / 255, alpha: 1.0),
            buttonTitleColour: chatList.titleColor,
            imageBackgroundColour: chatList.sectionHeaderFillColor
        )
    }
...
public final class PresentationTheme_iMe {
    public let accentColour: UIColor
    public let backgroundColour: UIColor
    public let secondaryBackgroundColour: UIColor
    public let titleTextColour: UIColor
    public let secondaryTextColour: UIColor
    public let disableButtonColour: UIColor
    public let newTagBackgroundColour: UIColor
    public let buttonTitleColour: UIColor
    public let imageBackgroundColour: UIColor
    
    public init(
        accentColour: UIColor,
        backgroundColour: UIColor,
        secondaryBackgroundColour: UIColor,
        titleTextColour: UIColor,
        secondaryTextColour: UIColor,
        disableButtonColour: UIColor,
        newTagBackgroundColour: UIColor,
        buttonTitleColour: UIColor,
        imageBackgroundColour: UIColor
    ) {
        self.accentColour = accentColour
        self.backgroundColour = backgroundColour
        self.secondaryBackgroundColour = secondaryBackgroundColour
        self.titleTextColour = titleTextColour
        self.secondaryTextColour = secondaryTextColour
        self.disableButtonColour = disableButtonColour
        self.newTagBackgroundColour = newTagBackgroundColour
        self.buttonTitleColour = buttonTitleColour
