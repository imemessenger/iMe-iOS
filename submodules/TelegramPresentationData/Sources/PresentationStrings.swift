...
public final class PresentationStrings {
    ...
    public var PrivacySettings_DataSettingsHelp: String { return self._s[1326]!.replacedTelegramToAiGram }
    ...
    public var Notifications_DisplayNamesOnLockScreenInfoWithLink: String { return self._s[2034]!.replacedTelegramToAiGram }
    ...
    public var Cache_Help: String { return self._s[2420]!.replacedTelegramToAiGram }
    ...
    public var Contacts_ShareTelegram: String { return self._s[2693]!.replacedTelegramToAiGram }
    ...
    public var Settings_AutoOpenBots: String {
        if self.baseLanguageCode == "ru" {
            return "Автоматические боты"
        }
        return "Automatic bots"
    }

    public var Settings_AdSuggestions: String {
        if self.baseLanguageCode == "ru" {
            return "Рекламные боты"
        }
        return "Advertisement bots"
    }

    public var Settings_BotMarket: String {
        if baseLanguageCode == "ru" {
            return "Магазин ботов"
        }
        return "Bot Market"
    }

    public var Settings_ChannelCollection: String {
        if baseLanguageCode == "ru" {
            return "Подборка каналов"
        }
    ...
    public var DialogList_NoChannelsTitle: String {
        if self.baseLanguageCode == "ru" {
            return "У вас нет подписок на каналы."
        }
        return "You have no subscribed channels"
    }

    public var DialogList_NoFoldersText: String {
        if self.baseLanguageCode == "ru" {
            return "Чтобы создать папку, нажмите на иконку в правом верхнем углу."
        }
        return "Create folder by pressing the button in the top right corner."
    }
    ...
    public var DialogList_NoChannelsText: String {
        if self.baseLanguageCode == "ru" {
            return "Нажмите на кноку \"Подборка\", чтобы выбрать тематический канал."
        }
        return "Tap \"Collection\" button to choose thematic channel."
    }
    ...
    public var GroupInfo_FolderNamePlaceholder: String {
        if self.baseLanguageCode == "ru" {
            return "Имя папки"
        }
        return "Folder Name"
    ...
    public var BotStore_Title: String {
        if self.baseLanguageCode == "ru" {
            return "Магазин ботов"
        }
        return "Bot Store"
    ...
    public var BotStore_AllCategory: String {
        //        if baseLanguageCode == "ru" {
        //            return "Все"
        //        }
        return "All"
    ...
    public var BotStore_PopularCategory: String {
        //        if baseLanguageCode == "ru" {
        //            return "Популярные"
        //        }
        return "Popular"
    ...
    public var BotStore_FreeCategory: String {
        //        if baseLanguageCode == "ru" {
        //            return "Бесплатные"
        //        }
        return "Free"
    ...
    public var BotStore_MyCategory: String {
        //        if baseLanguageCode == "ru" {
        //            return "Мои"
        //        }
        return "My"
    ...
    public var BotStore_GetBot: String {
        if baseLanguageCode == "ru" {
            return "ПОЛУЧИТЬ"
        }
        return "GET"
    ...
    public var BotStore_EnableBot: String {
        if baseLanguageCode == "ru" {
            return "ВКЛЮЧИТЬ"
        }
        return "ENABLE"
    ...
    public var BotStore_DisableBot: String {
        if baseLanguageCode == "ru" {
            return "ВЫКЛЮЧИТЬ"
        }
        return "DISABLE"
    ...
    public var BotStore_Free: String {
        return "Free"
    }

    public var BotStore_EmptyListPlaceholder: String {
        if baseLanguageCode == "ru" {
            return "В этой категории пока нет ботов"
        }
        return "There are no bots in this category yet"
    }

    public var BotStore_PurchaseErrorText: String {
        if baseLanguageCode == "ru" {
            return "Не удалось совершить покупку. Пожалуйста, попробуйте позже."
        }
        return "Purchase transaction failed. Please, try again later."
    }

    public var BotStore_PurchaseErrorTitle: String {
        if baseLanguageCode == "ru" {
            return "Ошибка подключения к iTunes"
        }
        return "iTunes Connection Failure"
    }

    public var BotStore_iTunesNotConnectedText: String {
        if baseLanguageCode == "ru" {
            return "Не удалось подключиться к iTunes. Подключите свою учётную запись и попробуйте позднее."
        }
        return "Failed to connnect to iTunes. Please, connect your account and try again later."
    }

    public var BotStore_iTunesNotConnectedTitle: String {
        if baseLanguageCode == "ru" {
    ...
    public var BotStore_ChangeBotStoreCountry: String {
        if baseLanguageCode == "ru" {
            return "Сменить язык нейроботов"
        }
        return "Change neurobots' language"
    }
    
    public var BotStore_LanguageSelectionTitle: String {
        if baseLanguageCode == "ru" {
            return "Язык"
        }
        return "Language"
    ...
    public var BotInfo_SupportedLanguages: String {
        if baseLanguageCode == "ru" {
    ...
    public var BotInfo_Installs: String {
        if baseLanguageCode == "ru" {
            return "Установок"
        }
        return "Installs"
    ...
    public var BotInfo_Topics: String {
        if baseLanguageCode == "ru" {
            return "Тем"
        }
        return "Themes"
    ...
    public var BotInfo_Phrases: String {
        if baseLanguageCode == "ru" {
            return "Фраз"
        }
        return "Phrases"
    ...
    public var BotInfo_Added: String {
        if baseLanguageCode == "ru" {
            return "Добавлено"
        }
        return "Added"
    ...
    public var BotInfo_Updated: String {
        if baseLanguageCode == "ru" {
            return "Обновлено"
        }
        return "Updated"
    ...
    public var BotInfo_Author: String {
        if baseLanguageCode == "ru" {
            return "Разработчик"
        }
        return "Author"
    ...
    public var BotInfo_Vote: String {
        if baseLanguageCode == "ru" {
            return "Оцените бота"
        }
        return "Vote"
    ...
    public var ChannelCollection_Hint: String {
        if baseLanguageCode == "ru" {
            return "Подборка каналов Telegram по категориям"
        }
        return "Telegram channels collection devided into categories"
    }

    public var ChannelCollection_Title: String {
        if self.baseLanguageCode == "ru" {
            return "Подборка каналов"
        }
        return "Channel collection"
    ...
    public var ChannelCollection_All: String {
        return "All"
    }

    public var ChannelCollection_Popular: String {
        return "Popular"
    }

    public var ChannelCollection_Categories: String {
        return "Categories"
    }

    public var ChannelCollection_My: String {


        return "My"
    }

    private let numberFormatter: NumberFormatter = with(.init()) {
        $0.numberStyle = .decimal
    }

    public func ChannelCollection_SubscribersCount(_ count: Int) -> String {
        let num = numberFormatter.string(from: .init(value: count)) ?? "\(count)"
        if self.baseLanguageCode == "ru" {
    ...
    public var ChannelCollection_Vote: String {
        if baseLanguageCode == "ru" {
            return "Оцените канал"
        }
        return "Vote"
    }

    public var ChannelCollection_Subscribers: String {
        if baseLanguageCode == "ru" {
            return "Подписчики"
        }
        return "Subscribers"
    ...
    public var ChannelCollection_JoinChannel: String {
        if baseLanguageCode == "ru" {
            return "Подписаться"
        }
        return "Join"
    ...
    public var ChannelCollection_LeaveChannel: String {
        if baseLanguageCode == "ru" {
            return "Отписаться"
        }
        return "Leave"
    ...
    public var ChannelCollection_SubscriptionFailed: String {
        if baseLanguageCode == "ru" {
            return "Ошибка подписки"
        }
        return "Sibscribing Error"
    }

    public var ChannelCollection_UnsubscriptionFailed: String {
        if baseLanguageCode == "ru" {
            return "Ошибка отписки"
        }
        return "Unsibscribing Error"
    }

    public var ChannelCollection_CommonError: String {
        if baseLanguageCode == "ru" {
            return "Ошибка соединения. Пожалуйста, попробуйте выполнить действие позднее"
        }
        return "Connection Error. Please try again later"
    }

    public var ChannelCollection_ChangeChannelCollectionCountry: String {
        if baseLanguageCode == "ru" {
            return "Сменить страну каналов"
        }
        return "Change country of channels"
    }

    public var ChannelCollection_CountrySelectionTitle: String {
        if baseLanguageCode == "ru" {
            return "Страна"
        }
        return "Country"
    ...
    public var ExtendedInfo_Link: String {
        if baseLanguageCode == "ru" {
            return "Ссылка"
        }
        return "Link"
    ...
    public func ExtendedInfo_RatesNum(_ ratesCount: String) -> String {
        if baseLanguageCode == "ru" {
            return "\(ratesCount) оценок"
        }
        return "\(ratesCount) votes"
    }
...
extension String {
    fileprivate var replacedTelegramToAiGram: String {
        return self.replacingOccurrences(of: "Telegram", with: "iMe")
    }
}
// MARK: -
