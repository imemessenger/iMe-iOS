...
@objc(AppDelegate) class AppDelegate: UIResponder, UIApplicationDelegate, PKPushRegistryDelegate/*, BITHockeyManagerDelegate*/, UNUserNotificationCenterDelegate, UIAlertViewDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        // MARK: - iMe
        if #available(iOS 13.0, *) {
            statusBarHost.setStatusBarStyle(.darkContent, animated: false)
        }
        // MARK: -
        ...
        let applicationBindings = TelegramApplicationBindings(isMainApp: true, containerPath: appGroupUrl.path, appSpecificScheme: buildConfig.appSpecificUrlScheme, openUrl: { url in
           ...
           clearMessageNotifications: { ids in
            ...
            if #available(iOS 10.3, *) {
                // MARK: - iMe
                var icons = [
                    PresentationAppIcon(name: "iMeMain", imageName: "iMeMainIcon", isDefault: buildConfig.isAppStoreBuild),
                    PresentationAppIcon(name: "iMeBlack", imageName: "iMeBlackIcon"),
                    PresentationAppIcon(name: "iMeWhite", imageName: "iMeWhiteIcon"),
                    PresentationAppIcon(name: "iMeMint", imageName: "iMeMintIcon"),
                    PresentationAppIcon(name: "iMeRed", imageName: "iMeRedIcon"),
                    PresentationAppIcon(name: "iMePurple", imageName: "iMePurpleIcon"),
                    PresentationAppIcon(name: "iMePink", imageName: "iMePinkIcon"),
                    PresentationAppIcon(name: "iMeYellow", imageName: "iMeYellowIcon"),
                    PresentationAppIcon(name: "iMeGray", imageName: "iMeGrayIcon")
