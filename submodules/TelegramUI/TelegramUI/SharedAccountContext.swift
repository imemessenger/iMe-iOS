...
// MARK: - iMe
extension SharedAccountContext {
    public func makeChatControllerTitlePanelNodeContainerInterface() -> ChatControllerTitlePanelNodeContainerInterface {
        return ChatControllerTitlePanelNodeContainer()
    }
}
// MARK: -
