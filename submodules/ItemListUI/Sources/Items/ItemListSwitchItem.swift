...
public class ItemListSwitchItem: ListViewItem, ItemListItem {
    ...
    // MARK: - iMe
    public init(theme: PresentationTheme, icon: UIImage? = nil, title: String, value: Bool, type: ItemListSwitchItemNodeType = .regular, enableInteractiveChanges: Bool = true, enabled: Bool = true, maximumNumberOfLines: Int = 1, sectionId: ItemListSectionId, style: ItemListStyle, updated: @escaping (Bool) -> Void, tag: ItemListItemTag? = nil) {
        self.icon = icon
    // MARK: -
        self.theme = theme
        self.title = title
