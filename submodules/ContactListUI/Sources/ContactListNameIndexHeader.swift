...
public final class ContactListNameIndexHeader: Equatable, ListViewItemHeader {
    public let id: Int64
    let theme: PresentationTheme
    let letter: unichar
    public let stickDirection: ListViewItemHeaderStickDirection = .top
    
    public let height: CGFloat = 29.0
    
    public init(theme: PresentationTheme, letter: unichar) {
        self.theme = theme
        self.letter = letter
    ...
    public static func ==(lhs: ContactListNameIndexHeader, rhs: ContactListNameIndexHeader) -> Bool {
        return lhs.id == rhs.id
    }
}

public final class ContactListNameIndexHeaderNode: ListViewItemHeaderNode {
