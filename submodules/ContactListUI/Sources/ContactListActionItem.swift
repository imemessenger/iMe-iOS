...
public class ContactListActionItem: ListViewItem, ListViewItemWithHeader {
    ...
    public init(theme: PresentationTheme, title: String, icon: ContactListActionItemIcon, highlight: ContactListActionItemHighlight = .cell, clearHighlightAutomatically: Bool = true, header: ListViewItemHeader?, action: @escaping () -> Void) {
        self.theme = theme
        self.title = title
        self.icon = icon
