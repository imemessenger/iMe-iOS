...
open class ListView: ASDisplayNode, UIScrollViewAccessibilityDelegate, UIGestureRecognizerDelegate {
    ...
    public final var didScroll: ((CGFloat, Bool) -> Void)?
    ...
    private func updateScrollViewDidScroll(_ scrollView: UIScrollView, synchronous: Bool) {
        ...
        // MARK: - iMe
        let previousValue = previousScrollViewOffset
        ...
        if scroller.contentOffset.y + scroller.bounds.height <= scroller.contentSize.height
            || scroller.contentSize.height <= scroller.bounds.height * 1.5
        {
            ...
            didScroll?(customContentOffset, abs(scrollView.contentOffset.y - previousValue) > 1_000)
        }
        // MARK: -
